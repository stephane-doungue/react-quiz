...
const QuizTopicsScreen: React.FC = () => {
  ...
  return (
    <PageCenter light justifyCenter>
      <CenterCardContainer>
        <Heading>
          BIENVENU SUR <HighlightedText> STEPHANE QUIZ</HighlightedText>
        </Heading>
        <DetailText>Sélectionnez le sujet ci-dessous pour démarrer votre quiz.</DetailText>
        ...
        <Button text="Continuer" onClick={goToQuizDetailsScreen} bold />
      </CenterCardContainer>
    </PageCenter>
  )
}
